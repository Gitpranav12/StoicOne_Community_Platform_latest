import { Users, Target, Mail, Calendar, BarChart3, TrendingUp, CheckCircle, ArrowRight } from 'lucide-react';
...
export function CRMPage({onNavigate}) {
  ...
  return (
    <div className="bg-white">
      {/* Hero Section */}
      <section className="py-5  bg-custom-lightblue-CRM text-white">
            ...
            <div className="col-md-6 col-lg-4" key={idx}>
              ...
              >
                ...
                <div className="card-body p-4 text-center">
                  ...
                  <button
                    className={`btn ${plan.popular ? 'btn-primary' : 'btn-outline-success'} w-100`}
                  >
                    Get Started
                  </button>
                </div>
