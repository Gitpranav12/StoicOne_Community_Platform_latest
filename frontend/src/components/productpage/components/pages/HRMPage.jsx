...
export function HRMPage({ onNavigate }) {
  ...
  const features = [
    {
      ...
      description:
        "Centralize all employee information with secure profile management, organized documents, and comprehensive record keeping for easy access and administration.",
    },
    {
      icon: <Calendar size={48} />,
      title: "Leave & Attendance",
      description:
        "Manage employee leave with automated requests and approvals, plus real-time attendance tracking and detailed reports for consistent workforce oversight.",
    },
    {
      icon: <BarChart3 size={48} />,
      title: "Performance Tracking",
      description:
        "Set clear goals and monitor key performance metrics for each employee, making regular reviews simple and effective with structured feedback.",
    },
    {
      icon: <Users size={48} />,
      title: "Recruitment",
      description:
        "Streamline your entire hiring workflow from job postings, candidate screening, and applicant tracking, through to onboarding new team members smoothly.",
    },
    {
      icon: <Award size={48} />,
      title: "Training & Development",
      description:
        "Coordinate employee training and certification programs, track skill development, and visualize progress to empower continuous growth.",
    },
    {
      icon: <Clock size={48} />,
      title: "Payroll Integration",
      description:
        "Synchronize payroll processes for accurate salary calculations, seamless payslip generation, and reliable automated reporting.",
    },
  ];
  ...
  return (
    <div className="bg-white">
      {/* Hero Section */}
      <section
        className="py-5 bg-custom-lightgreen-HRM text-black"
        style={{
          background:
            "linear-gradient(135deg, #ffffff 0%, #e3f2fd 30%, #bbfbc0ff 70%, #ffffff 100%)",
            ...
            <div className="col-lg-6 text-start px-2">
              <div className="mb-4">
                <span
                  ...
                  style={{
                    backgroundColor: "#e4fde3ff",
                    color: "#1ee550ff",
                    fontSize: "0.9rem",
                    fontWeight: "600",
                    border: "2px solid #1ee51e50",
                  }}
                >
                  HRM Solution
                </span>
              </div>
              <h1 className="display-3 fw-bold mb-4">Empower Your Workforce</h1>
              <p className="lead mb-4">
                Complete HR management system to handle employees, track
                performance, streamline recruitment, and manage your entire
              ...
              <div className="d-flex gap-3 mb-4">
                <button
                  ...
                  style={{
                    background: "linear-gradient(135deg, #1ee539ff, #56ff7bff)",
                    color: "white",
                    border: "none",
                    borderRadius: "12px",
                    padding: "14px 32px",
        ...
        <div className="container-fluid px-3 px-md-5 py-5">
          <div className="row align-items-center">
            ...
            <div className="col-lg-6">
              <h2 className="display-5 fw-bold mb-4">Why Choose Our HRM?</h2>
              <p className="lead text-muted mb-4">
                Trusted by HR departments to streamline operations and improve
                employee experience.
              </p>
      ...
      <section className="py-5 bg-success text-white">
        <div className="container-fluid px-3 px-md-5 py-5 text-center">
