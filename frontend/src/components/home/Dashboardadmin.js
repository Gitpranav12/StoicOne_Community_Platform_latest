      ...
      <>
        <div key={refreshKey}>
          <div className="p-4">
            ...
            <Row>
              <Col md={8}>
                <QuestionsList questions={recentQuestions} />
              </Col>
              <Col md={4}>
                <div className="d-flex flex-column gap-3">
                  <Card className="border">
                    <Card.Body>
                      <h6 className="heading-text mb-2">The Overflow Blog</h6>
                      <p className="normal-text text-muted mb-1">Open-source is for the people, by the people</p>
                      <p className="normal-text text-muted mb-0">Moving the public Stack Overflow sites to the cloud: Part 1</p>
                    </Card.Body>
                  </Card>
                  <Card className=" border">
                    <Card.Body>
                      <h6 className="heading-text mb-2">Featured on Meta</h6>
                      <p className="normal-text text-muted mb-0">Moving Stack Overflow to the cloud...</p>
                    </Card.Body>
                  </Card>
                  <CommunityActivity />
                </div>
